...
image_sequence_count=$(find /xdisk/rpalaniv/cedar/cv/images/source_tifs/ -maxdepth 1 -name '*run*' | wc -l)
...
mkdir /groups/rpalaniv/backed_up/cedar/image_processing/logs/${folder_name}
cd /groups/rpalaniv/backed_up/cedar/image_processing/logs/${folder_name}
...
sbatch --array=1-${image_sequence_count} /home/u16/cedar/git/organize_and_process_microscope_images/slurm/process_image_sequences_camera_2.slurm
