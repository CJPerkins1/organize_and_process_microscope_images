...
image_sequence_count=$(find /xdisk/rpalaniv/cedar/image_processing/source_tifs/ -maxdepth 1 -name '*run*' | wc -l)
...
sbatch --array=1-${image_sequence_count} /home/u16/cedar/git/organize_and_process_microscope_images/slurm/process_image_sequences.slurm
